...
router.post("/", verify_1.verifyToken, upload_1.upload.single("avatar"), users_1.UserControllers.createUser);
router.get("/events/trending", trending_1.TrendingEventsController.getTrendingEvents);
router.get("/events/favorites/", verify_1.verifyToken, favorites_1.FavoriteController.getFavorites);
