...
router.get(
  "/",
  verify_1.verifyToken,
  eventPlanner_1.EventPlannerControllers.getEventPlanners,
);
router.get(
  "/dashboard/:plannerId",
  verify_1.verifyToken,
  dashboard_1.DashboardController.getEventPlannerDashboard,
);
...
router.delete(
  "/:id",
  verify_1.verifyToken,
  eventPlanner_1.EventPlannerControllers.deleteEventPlanner,
);
